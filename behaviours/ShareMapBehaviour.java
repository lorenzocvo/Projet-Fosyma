...
public class ShareMapBehaviour extends TickerBehaviour{
	...
	protected void onTick() {
		...
		MessageTemplate msgTemplate = MessageTemplate.MatchProtocol("SHARE-TOPO");
		...
		if (msgReceived!=null) {
			...
			MessageTemplate msgTemplate2 = MessageTemplate.MatchProtocol("ASK-TOPO");
			ACLMessage msgReceived2=this.myAgent.receive(msgTemplate2);
			//ACLMessage msg = new ACLMessage(ACLMessage.INFORM);
			if (msgReceived2!=null) {
				System.out.println(msgReceived2);
				ACLMessage msg = msgReceived2.createReply();

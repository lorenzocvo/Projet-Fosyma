...
import eu.su.mas.dedaleEtu.mas.agents.dummies.explo.ControlledAgent;
...
//		 * AGENT Explo5
		...
		//
		//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo5={"A1","A2","A3","A4","A6"};
		//
		//		//4) Give the class name of your agent to let the system instantiate it
		...
		//
		//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo6={"A1","A2","A3","A4","A5"};
		//
		//		//4) Give the class name of your agent to let the system instantiate it
		...
		agentName="G1";        
		Object [] entityParameters0={"A1","A2","A3","A4","A5","A6"};
		ag=createNewDedaleAgent(c, agentName, DummyWumpusShift2.class.getName(), entityParameters0);    agentList.add(ag); 
		
		agentName="G2";        
		Object [] entityParameters1={"A1","A2","A3","A4","A5","A6"};
		ag=createNewDedaleAgent(c, agentName, DummyWumpusShift.class.getName(), entityParameters1);    agentList.add(ag); 
		...
		//	
		//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC={"A1","A2","A3","A4","A5"};
		//		
		//		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, ExploreCoopAgent.class.getName(), entityParametersExploC);//ExploreSoloAgent
		agentList.add(ag);
		*/
		/***************
		 * AGENT Tanker
